...
# docker build --build-arg PASSWORD="wherebnb" --build-arg PUBLIC_IP_ADDRESS="34.173.224.187" --build-arg DBNAME="accounts" --build-arg PROJECT_ID="useful-memory-414316" --build-arg INSTANCE_NAME="wherebnb-dev-db" -t damonwong2022148/account:1.0 .